...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(yasnippet window-numbering smartparens session persp-projectile paredit pangu-spacing org2blog org-page multiple-cursors markdown-mode magit lua-mode jedi indent-guide helm-projectile helm-gtags helm-ag guide-key fuzzy flycheck csharp-mode color-theme-sanityinc-tomorrow chinese-pyim cdlatex auto-compile auctex))))
(custom-set-faces
